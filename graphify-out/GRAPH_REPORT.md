...
## Corpus Check
- 42 files · ~32,696 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 247 nodes · 219 edges · 32 communities (31 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6e814877`
...
1. `Universal Autonomous-Agent Operating Framework — **Claude edition**` - 23 edges
2. `Universal Autonomous-Agent Operating Framework — **Codex edition**` - 23 edges
...
5. `Execution plan (in order; stop and ask if anything is ambiguous)` - 13 edges
6. `Social Network Agent — Project Schema` - 13 edges
7. `Execution plan (in order; stop and ask if anything is ambiguous)` - 13 edges
8. `HANDOVER — universal autonomous-agent framework (Codex, portable)` - 8 edges
9. `Repository selection for the ADAMA social media agent` - 8 edges
10. `userIgnoreFilters` - 6 edges
...
Cohesion: 0.18
Nodes (10): alwaysUpdateLinks, attachmentFolderPath, .agents, .claude, graphify-out, node_modules, .venv, newLinkFormat (+2 more)
...
Cohesion: 0.20
Nodes (9): 0. What's in this bundle, 1. Prereqs on the new machine, 2. Install — the 3 steps, 3. First run — make the graph appear, 4. Verify the install (don't trust stdout — re-read), 5. After install — recreate the per-machine bits (framework §14), 6. What changed since the last handover (2026-07 method update), HANDOVER — universal autonomous-agent framework (Codex, portable) (+1 more)

### Community 10 - "Knowledge Base Index"
Cohesion: 0.14
Nodes (12): ADAMA, Concepts, Entities, Knowledge Base Index, Overview, Sources, Social Network Agent — Overview, ADAMA social media agent — project brief (+4 more)
...
Cohesion: 0.40
Nodes (4): agent-env-setup — one-button new-environment install, How to run it, Notes & guardrails, What it installs
...
### Community 17 - "log.md"
Cohesion: 0.50
Nodes (3): [2026-07-25] ingest | ADAMA project brief and repository research, [2026-07-25] update | adopt universal agent framework, Wiki Log
...
## Knowledge Gaps
- **187 isolated node(s):** `attachmentFolderPath`, `newLinkFormat`, `useMarkdownLinks`, `alwaysUpdateLinks`, `node_modules` (+182 more)
...
- **Should `Universal Autonomous-Agent Operating Framework — **Codex edition**` be split into smaller, more focused modules?**
  _Cohesion score 0.08333333333333333 - nodes in this community are weakly interconnected._
- **Should `Execution plan (in order; stop and ask if anything is ambiguous)` be split into smaller, more focused modules?**
